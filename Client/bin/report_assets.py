...
if __name__ == '__main__':
    windows_data = {
        "os_type": "Windows",
        "os_release": "10 64bit  10.0.18362 ",
        ...
        "model": "P67X-UD3R-B3",
        "wake_up_type": 6,
        "sn": "10426-OEM-8992662-111114",
        "physical_disk_driver": [
            {
                "iface_type": "unknown",
                "slot": 0,
                "sn": "3830414130423230343234362020202020202025",
            ...
            },
            {
                "iface_type": "SATA",
                "slot": 1,
                "sn": "383041413042323023234362020102020202025",
                "model": "KINGSTON SV100S264G ATA Device",
                "manufacturer": "(标准磁盘驱动器)",
                "capacity": 2048
            },
    ...
    linux_data = {
        ...
        "sn": "00005",
        "model": "VirtualBox",
        "uuid": "E8DE611C-4279-495C-9B58-502B6FCED077",
        ...
        "ram_size": 15.858997344970703,
        "nic": [],
        "physical_disk_driver": [
            {
                "model": "VBOX HARDDISK",
                "size": "1000",
                "sn": "VBeee1ba73-09085304"
            }
        ]
    }
